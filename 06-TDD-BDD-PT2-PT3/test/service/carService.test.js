...
import mockCarCategory from './../mocks/valid-carCategory.json' assert { type: "json" };
import mockCar from './../mocks/valid-car.json' assert { type: "json" };
import mockCustomer from './../mocks/valid-customer.json' assert { type: "json" };
import Transaction from '../../../aula05-tdd-project-pt03/src/entities/transaction.js'
const mocks = {
    validCarCategory: mockCarCategory,
    validCar: mockCar,
    validCustomer: mockCustomer,
}
